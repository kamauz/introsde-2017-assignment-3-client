...
public class ObjectFactory {
    ...
    private final static QName _Preference_QNAME = new QName("http://soap.assignment3.introsde/", "preference");
    ...
    private final static QName _ReadPersonPreferences2Response_QNAME = new QName("http://soap.assignment3.introsde/", "readPersonPreferences2Response");
    ...
    private final static QName _ReadPersonPreferences1Response_QNAME = new QName("http://soap.assignment3.introsde/", "readPersonPreferences1Response");
    private final static QName _ReadPreferences_QNAME = new QName("http://soap.assignment3.introsde/", "readPreferences");
    private final static QName _ReadPersonPreferences1_QNAME = new QName("http://soap.assignment3.introsde/", "readPersonPreferences1");
    private final static QName _ReadPersonPreferences2_QNAME = new QName("http://soap.assignment3.introsde/", "readPersonPreferences2");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.assignment3.introsde/", name = "preference")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.assignment3.introsde/", name = "readPersonPreferences2Response")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.assignment3.introsde/", name = "readPersonPreferences1Response")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.assignment3.introsde/", name = "readPersonPreferences1")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.assignment3.introsde/", name = "readPersonPreferences2")
