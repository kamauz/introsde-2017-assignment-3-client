 ...
 * 
 */
@WebServiceClient(name = "PeopleService", targetNamespace = "http://soap.assignment3.introsde/", wsdlLocation = "http://localhost:8080/es3/people?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/es3/people?wsdl");
